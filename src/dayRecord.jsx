...
function DayRecord({ newDate, setDayActive }) {
  ...
  const [isAllDay, setIsAllDay] = useState('text-white border border-white rounded-xl px-12 py-4 ml-5 hover:bg-darkGreen');
  ...
  return (
    <div className=" w-8/12 bg-black p-5 shadow-shad rounded-xl">
      ...
      <button onClick={handleClick} className="text-white border border-white rounded-lg  px-12 py-2 hover:bg-blue-300 mt-5 bg-darkGreen ">
        Valider
      </button>
    </div>
  );
